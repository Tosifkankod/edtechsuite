...
import { useTrainer } from '../hooks/queryHooks';
...
const TrainerIndex = () => {
  ...
  const { data, isLoading } = useTrainer({
    page: pageIndex + 1,
    limit: pageSize,
    sortBy: sorting[0]?.id,
  ...
  const studentColumns: ColumnDef<Trainer>[] = [
    {
      accessorKey: "id",
      header: 'trainer Id'
    },
  ...
  return (
    <div className="h-full py-4 scroll-smooth">
      <div className="mb-4">
        <h1 className="text-3xl font-medium">Manage Trainer</h1>
